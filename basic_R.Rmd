...
set.seed(42)
x <- sample(c(TRUE, FALSE), size = 5, replace = TRUE, prob = c(0.25, 0.75))
...
m <- matrix(letters[10:12], nrow=6, ncol=4, byrow = TRUE, dimnames=list(paste(c("rekke", "rad"), 1:4, sep="_"), paste("kol", LETTERS[1:4], sep="")))

letters[10:12]
# Do not run
m <- matrix(letter[10:12], nrow=6, ncol=4, byrow = TRUE, dimnames=list(paste(c("rekke", "rad"), rep(1:3, 2), sep="_"), paste("kol", LETTERS[1:4], sep="")))
```
