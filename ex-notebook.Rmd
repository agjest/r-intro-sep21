...
RStudio vil selv endre litt i YAML, spesielt gjelder dette `output:` verdien som blir endret hvis vi velger et annet format i `Preview`menyen. $a^2 + b^2 = c^2$

Slettet tekst fra gren intro. Legger til mer tekst i branch intro1. Edrer på teksten og får andre kcommit i intro1.
